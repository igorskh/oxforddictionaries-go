...
// BilingualLexicalEntry Description of an entry for a particular part of speech
type BilingualLexicalEntry struct {
	...
	Entries *[]BilingualEntry `json:"entries,omitempty"`
...
// SetEntries gets a reference to the given []BilingualEntry and assigns it to the Entries field.
...
func (o BilingualLexicalEntry) MarshalJSON() ([]byte, error) {
...
type NullableBilingualLexicalEntry struct {
	value *BilingualLexicalEntry
	isSet bool
}

func (v NullableBilingualLexicalEntry) Get() *BilingualLexicalEntry {
	return v.value
}

func (v *NullableBilingualLexicalEntry) Set(val *BilingualLexicalEntry) {
	v.value = val
	v.isSet = true
}

func (v NullableBilingualLexicalEntry) IsSet() bool {
	return v.isSet
}

func (v *NullableBilingualLexicalEntry) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableBilingualLexicalEntry(val *BilingualLexicalEntry) *NullableBilingualLexicalEntry {
	return &NullableBilingualLexicalEntry{value: val, isSet: true}
}

func (v NullableBilingualLexicalEntry) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableBilingualLexicalEntry) UnmarshalJSON(src []byte) error {
	v.isSet = true
