...
// LemmasApiService LemmasApi service
type LemmasApiService service

type ApiLemmasSourceLangWordIdGetRequest struct {
	ctx _context.Context
	ApiService *LemmasApiService
	sourceLang string
	wordId string
	appId *string
	appKey *string
...
func (r ApiLemmasSourceLangWordIdGetRequest) AppId(appId string) ApiLemmasSourceLangWordIdGetRequest {
	r.appId = &appId
	return r
}
func (r ApiLemmasSourceLangWordIdGetRequest) AppKey(appKey string) ApiLemmasSourceLangWordIdGetRequest {
	r.appKey = &appKey
	return r
}
func (r ApiLemmasSourceLangWordIdGetRequest) GrammaticalFeatures(grammaticalFeatures string) ApiLemmasSourceLangWordIdGetRequest {
	r.grammaticalFeatures = &grammaticalFeatures
	return r
}
func (r ApiLemmasSourceLangWordIdGetRequest) LexicalCategory(lexicalCategory string) ApiLemmasSourceLangWordIdGetRequest {
	r.lexicalCategory = &lexicalCategory
	return r
}

func (r ApiLemmasSourceLangWordIdGetRequest) Execute() (Lemmatron, *_nethttp.Response, error) {
	return r.ApiService.LemmasSourceLangWordIdGetExecute(r)
}

/*
 * LemmasSourceLangWordIdGet Check a word exists in the dictionary and retrieve its root form
 * 
 ...
 * @return ApiLemmasSourceLangWordIdGetRequest
 */
func (a *LemmasApiService) LemmasSourceLangWordIdGet(ctx _context.Context, sourceLang string, wordId string) ApiLemmasSourceLangWordIdGetRequest {
	return ApiLemmasSourceLangWordIdGetRequest{
		ApiService: a,
		ctx: ctx,
 ...
 * @return Lemmatron
 */
func (a *LemmasApiService) LemmasSourceLangWordIdGetExecute(r ApiLemmasSourceLangWordIdGetRequest) (Lemmatron, *_nethttp.Response, error) {
	var (
		...
		localVarReturnValue  Lemmatron
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "LemmasApiService.LemmasSourceLangWordIdGet")
	if err != nil {
		return localVarReturnValue, nil, GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/lemmas/{source_lang}/{word_id}"
